...
\usepackage[backend=bibtex8,sorting=nyt,style=alphabetic]{biblatex}
...
\printbibliography[nottype=misc,title={Bibliography},heading=subbibliography]
\printbibliography[type=misc,title={Online references},heading=subbibliography]
