  ...
  \begin{itemize}
    ...
    \item It consists of two steps:
      \begin{itemize}
        ...
        \item \textmark{Reduce}: combine the results of the mapping using an associative operation.
      \end{itemize}
...
\begin{itemize}
  \item \textgood{Solution}: The new combination operation is now associative, so the result is deterministic and can be parallelized.
\end{itemize}
