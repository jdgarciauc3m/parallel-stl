...
\begin{itemize}
  \item A range is any type that respresents a sequence of elements.
\begin{lstlisting}
template <typename T>
...
\end{lstlisting}
    \begin{itemize}
      ...
      \item If the type of \cppcode{std::begin(t)} is a forward iterator, then \cppcode{[std::begin(t)} is equality preserving (i.e., multi-pass is allowed).
    \end{itemize}
\end{itemize}
\end{frame}
